...
const SponsorUs: React.FC = () => {
  ...
  const ourSponsors: SponsorItem[] = [
    ...
    { id: 2, name: "osen", image: "/images/Sponsors/osenSponsor.png", link: "#", effect: "fade-up", SubSponsorcategory: "Gold Sponsor" },
    { id: 3, name: "imperial", image: "/images/Sponsors/imperialSponsor.png", link: "#", effect: "fade-up", SubSponsorcategory: "General Sponsor" },
